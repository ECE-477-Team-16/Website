...
exports.storeLocation = function(user, lat, long, radius, callback)
{
	console.log(lat);
	console.log(long);
	accounts.findOneAndUpdate({user:user}, {$set: {"lat": lat, "long": long, "radius": radius}}, function(e, o) {
		if (o){
...
exports.alarmState = function(user, alarmState, callback)
{
	console.log("alarmState", alarmState);
	accounts.findOneAndUpdate({user:user}, {$set: {"alarmState": alarmState}}, function(e, o) {
		if (o){
			console.log("set alarmState");
			//console.log(o);
			//o.pass == pass ? callback(o) : callback(null);
		}	else{
			callback(null);
